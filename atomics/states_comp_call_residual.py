...
from atomics.pdes.dev.linear_elastic import get_residual_form
    ...
    def initialize(self):
        ...
        self.options.declare(
            ...
            values=[
                ...
                'petsc_gmres_ilu', 'petsc_cg_ilu'
            ],
        )
        self.options.declare(
            'problem_type',
            default='nonlinear_problem_load_stepping',
            values=[

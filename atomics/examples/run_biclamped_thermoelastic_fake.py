...
pde_problem.add_state('mixed', displacements_function, residual_form, 'density')
...
pde_problem.add_scalar_output('compliance', compliance_form, 'mixed')
...
comp = om.ExecComp('maximum_temperature=mixed')
prob.model.add_subsystem('ks_comp', comp, promotes=['*'])

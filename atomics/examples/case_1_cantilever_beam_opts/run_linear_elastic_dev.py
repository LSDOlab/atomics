...
method = 'SIMP'
residual_form = get_residual_form(displacements_function,
                                  v,
                                  density_function,
                                  method=method)
...
group = AtomicsGroup(pde_problem=pde_problem, call_residual='False')
...
prob.model.add_constraint('avg_density', upper=0.22)
